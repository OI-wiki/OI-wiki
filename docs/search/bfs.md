...
优先队列，相当于一个二叉堆，STL 中提供了 [`std::priority_queue` 容器](https://oi-wiki.org/ds/stl/priority_queue/)，可以方便我们使用优先队列。
...
诶？这怎么听起来这么想堆优化的 [Dijkstra](https://oi-wiki.org/graph/shortest-path/#dijkstra) 算法呢？事实上，堆优化 Dijkstra 就是优先队列 BFS。
