...
- [P8593](https://www.luogu.com.cn/problem/P8593)
逆序对的应用。

- [AcWing 4709. 三元组](https://www.acwing.com/problem/content/4712/)
上题的弱化版，同样为逆序对的应用。

- [P8773 [蓝桥杯 2022 省 A] 选数异或 ](https://www.luogu.com.cn/problem/P8773)
HH 的项链魔改版。

- [P8844 [传智杯 #4 初赛] 小卡与落叶](https://www.luogu.com.cn/problem/P8844)
树上问题转序列问题然后进行二维数点。
