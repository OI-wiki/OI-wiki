数位 DP 常常用于解决这样一类问题：给定一个闭区间 $[l,r]$，让你求这个区间中满足 **某种条件** 的数的总数。
...
- [BZOJ3679 数字之积](https://www.lydsy.com/JudgeOnline/problem.php?id=3679)
- [ZJOI2010 数字计数](https://loj.ac/problem/10169)
- [AHOI2009 同类分布](https://www.luogu.com.cn/problem/P4127)
