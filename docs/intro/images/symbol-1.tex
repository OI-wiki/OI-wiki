...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \draw[unit vector] (O) -- (1,0,0) node[anchor=east]{$\mathbf{e}_x$};
    \draw[unit vector] (O) -- (0,1,0) node[anchor=south]{$\mathbf{e}_y$};
    \draw[unit vector] (O) -- (0,0,1) node[anchor=east]{$\mathbf{e}_z$};
    
    \draw[vector] (O) -- (P) node[anchor=west]{$\mathbf{r}$};
