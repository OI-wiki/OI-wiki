...
工具栏 - 应用程序 - 编程 - Arbiter测评系统，启动 Arbiter。
...
这一步**十分重要：**点击文件 - 保存！一定要保存，否则没有题目配置文件！
...
有一天，他用 GUIDE 的时候发现单步调试功能出问题了，于是他致信北航相关项目负责人询问解决办法，得到的回复是：“这个项目已经停止更新了。”
