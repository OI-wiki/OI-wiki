...
亦可打开[https://www.microsoft.com/zh-cn/p/Ubuntu/9 nblggh4 msv6](https://www.microsoft.com/zh-cn/p/ubuntu/9nblggh4msv6)  
???+ warning
...
???+ warning  
**请在页面中寻找与自己系统版本相配的源（可使用`sudo lsb_release -a`查看，具体详见`0 x03`）  
