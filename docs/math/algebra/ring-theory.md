...
???+ abstract "左理想"
    给定环 $R$ 和它的子环 $I$，则称 $I$ 是 $R$ 的 **左理想**（left ideal），如果对于所有 $r\in R$，都有 $rI\subseteq I$，这里，$rI=\{ra:a\in I\}$。

???+ abstract "右理想"
    给定环 $R$ 和它的子环 $I$，则称 $I$ 是 $R$ 的 **右理想**（left ideal），如果对于所有 $r\in R$，都有 $Ir\subseteq I$，这里，$Ir=\{ar:a\in I\}$。

???+ abstract "理想"
    给定环 $R$ 和它的子环 $I$，则称 $I$ 是 $R$ 的 **理想**（ideal），如果 $I$ 既是 $R$ 的左理想，也是 $R$ 的右理想。
