...
作为数学常数出现时，自然常数在 LaTeX 里书写为正体 $\mathrm{i}$。
...
- sqrt2，$\sqrt{2}$。
- sqrt3，$\sqrt{3}$。
- inv\_sqrt3，$\frac{1}{\sqrt{3}}$。
- phi，黄金比常数 $\Phi$，$\frac{1+\sqrt{5}}{2}$。

黄金比常数 $\Phi$ 是指，将一个长度分割成大小两段，如果小段与大段的长度之比等于大段的长度与全长之比，那么这一比值称为黄金比或黄金分割。这里的比值约为 1.6180339887。
