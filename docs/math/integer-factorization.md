...
例如， $4817191$ 的质因数分解是 $1303 \cdot 3697$ 。由于 $1303 - 1 = 2 \cdot3 \cdot 7 \cdot 31$ ， $3697 - 1 = 2^4 \cdot 3 \cdot 7 \cdot 11$ ，这两个质因子就分别是 **31-powersmooth** （也可以是 **32-powersmooth** ， **33-powersmooth** 等等）和 **16-powersmooth** （同上，可以是 **17-powersmooth** ， **18-powersmooth** 等等）。1974 年，约翰·波拉德发明了一种从合数中提取 **B-powersmooth** 因子的方法。
