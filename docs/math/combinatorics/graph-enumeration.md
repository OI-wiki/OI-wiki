...
假设对于每个无根树，我们都设置它的重心为根，此时无根树与某种有根树可以建立起一一对应关系。
因此我们只要用有根树的方案中减去根不是重心的方案即可，我们对 n 的奇偶性进行讨论。
