...
[洛谷P3803评测记录](www.luogu.com.cn/record/list?pid=P3803&user=saisyc)显示，按照 [*Optimization of number-theoretic transform in programming contests*]() 实现的 NTT 及与其同构的 CNTT, FFT 进行 $2^{21}\approx2.1\times10^6$ 长度的变换用时分别约为 $44,97,115$ 毫秒。
