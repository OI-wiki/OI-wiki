...
[^burgess1962character]: BURGESS, David A. On character sums and primitive roots. _Proceedings of the London Mathematical Society_, 1962, 3.1: 179-192.

[^yuan1959note]: Wang Y. On the least primitive root of a prime (in Chinese). _Acta Math Sinica_, 1959, 4: 432–441; English transl. in _Sci. Sinica_, 1961, 10: 1–14

[^fridlender1949least]: FRIDLENDER, V. R. On the least n-th power non-residue. In: _Dokl. Akad. Nauk SSSR_. 1949. p. 351-352.

[^salie1949kleinsten]: SALIÉ, Hans. Über den kleinsten positiven quadratischen Nichtrest nach einer Primzahl. _Mathematische Nachrichten_, 1949, 3.1: 7-8.
