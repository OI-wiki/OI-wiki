 ...
 **本页面主要译自博文 [Генерация сочетаний из N элементов Сочетания из N элементов по K в лексикографическом порядке](http://e-maxx.ru/algo/generating_combinations) 与其英文翻译版 [generating_combinations](https://cp-algorithms.com/combinatorics/generating_combinations.html) 。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。** 
