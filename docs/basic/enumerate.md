...
[^1]: [桶排序](https://oi-wiki.org/basic/bucket-sort/) 以及 [主元素问题](https://oi-wiki.org/misc/main-element/#_3) 以及 [Stack Overflow 上对桶数据结构的讲解](https://stackoverflow.com/questions/42399355/what-is-a-bucket-or-double-bucket-data-structure)（英文）
