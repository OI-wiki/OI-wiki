...
??? note " 例题 1 [Luogu P3806【模板】点分治 1](https://www.luogu.com.cn/problem/P3806)"
    ...
    $n\leqslant 10000,m\leqslant 100,k\leqslant 10000000$
...
??? note " 例题 2 [Luogu P4178 Tree](https://www.luogu.com.cn/problem/P4178)"
    ...
    $n\leqslant 40000,k\leqslant 20000,w_i\leqslant 1000$
...
??? note " 例题 3 [Luogu P2664 树上游戏](https://www.luogu.com.cn/problem/P2664)"
    一棵每个节点都给定颜色的树，定义 $s(i,j)$ 为 $\mathit{i}$ 到 $\mathit{j}$ 的颜色数量，$\mathit{sum_{i}}=\sum_{j=1}^n s(i,j)$。对所有的 $1\leqslant i\leqslant n$，求 $sum_i$。（$1 \leqslant n, c_i \leqslant 10^5$）
