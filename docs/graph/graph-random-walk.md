...
<div style="text-align:center">
    <img src="images/graph-random-walk-1.svg" alt="graph-random-walk">
</div>
接下来要对下一个绿色格子对应的方程进行消元。在这个方程中，只有绿色格子和它下方的第一个黑色格子对应的变量系数可能不为 0 ;而只有绿色格子和它下方的第一个黑色格子对应的方程中，当前格子对应的变量系数可能不为0。
