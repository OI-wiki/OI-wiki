...
![](./images/Network-Flow-Maximum-Flow_1.png)

如果我们把每条边的的信息用**残量 / 容量**表示出来，可以得到下图：

![](./images/Network-Flow-Maximum-Flow_2.png)

假设我们第一次找到的増广路为 $1-2-3-4$，那么我们把这条路径上的边的 $w(u,v)$ 减去 $\min\{f(u,v)\}$ 即 $1$，得到下图：

![](./images/Network-Flow-Maximum-Flow_3.png)
...
![](./images/Network-Flow-Maximum-Flow_8.png)
