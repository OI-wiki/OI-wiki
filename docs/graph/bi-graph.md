...
1.首先从任意一个未配对的点$u$开始，选择他的任意一条条边（$u$-$v$），如此时$v$还未配对，则配对成功，配对数加一，若$v$已经配对，则尝试寻找v的配对的另一个配对，若该尝试成功，则配对成功，配对数加一。
...
我们发现5已经被匹配了，所以我们尝试寻找5的匹配的其他匹配，即2的其他匹配。类是的，我们可以找到6。
