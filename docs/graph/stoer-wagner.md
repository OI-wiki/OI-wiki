...
![GFI{X2({P2CK 9}CLO@2 S0](https://user-images.githubusercontent.com/99392294/153379462-aa531906-6b84-4bc6-b6d8-e825e4b0c774.png)

如图，AB 为两个不同的连通块，\[] 中的数字为加入 $A$ 的顺序，灰色节点为活跃节点，白色节点则不是
