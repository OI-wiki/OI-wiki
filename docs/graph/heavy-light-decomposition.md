...
在学习本部分时，请先学习 **[线段树](https://oi-wiki.org/ds/segment/)** 的相关内容。

## 树链剖分的思想及能解决的问题

一棵静态（形状固定的）树，要求进行几种操作：

1.修改 **单个节点/树上两点之间的最短路径/一个节点的子树上** 的所有点的值。

2.查询 **单个节点/树上两点之间的最短路径/一个节点的子树上** 节点的值得 **和/极值/其他（具有较强的合并性）** 。
...
由于树链剖分的思想十分暴力，所以被OIers戏称为 **“优雅的暴力”** 。
