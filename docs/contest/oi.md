...
**CTT**（英文：China Team Training，中文：国际信息学奥林匹克国家集训队培训）是每年冬天为 IOI 国家集训队选手举办的集训活动，由 3-4 场测试组成。除国家集训队外，部分在当年 NOI 中取得优异成绩的选手也可以“精英集训”的名义参加 CTT。
...
APIO 参赛选手可分为 A 类和 B 类，A 类选手中的前六名选手（含并列）可参与 APIO 的国际奖项评选；而 B 类选手只能参与中国赛区的奖项评选。
