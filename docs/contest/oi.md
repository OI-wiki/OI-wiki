...
目前国内 OJ 对于 NOI SG 的题目收录比较匮乏，[洛谷](https://www.luogu.com.cn/problem/list?tag=436&page=1) 收录了部分近年的题目，可以在 [官方的 GitHub 帐号](https://github.com/noisg) 上找到历年题面、测试数据和官方标准程序。
