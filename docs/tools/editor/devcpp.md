...
以上的 Dev-C++ 分发都被认为是「官方的」。此外，在 2015 年 Orwell Dev-C++ 停止更新后，在中国出现了两个由个人开发者维持的分支版本，这两个分支版本都非常便于国内的个人使用和学习。
一个是 [XiaoLoong Dev-C++](https://gitee.com/devcpp/devcpp)，它在原版本的基础上改进了软件界面，使之具有现代化的界面风格；同时增加了“保存文件时自动格式化”的特性，并集成了完全中文化的高版本 MinGW GCC 编译器。
另一个是 [royqh1979](https://github.com/royqh1979) 开发的小熊猫 Dev-C++[^ref2]，集成了智能提示和高版本的 MinGW64 GCC。
