...
\begin{tikzpicture}
    \matrix[row sep=1cm, column sep=1cm] {
        ...
        \node[draw, fill=red, circle] (10) at (-2, -2) {\textcolor{white}{10}};
        \node[draw, fill=black, circle] (12) at (-1, -2) {\textcolor{white}{12}};
        ...
        \node[draw, fill=red, circle] (13) at (0, -2) {\textcolor{white}{13}};
