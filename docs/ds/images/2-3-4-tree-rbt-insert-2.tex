...
\begin{tikzpicture}
    \matrix[row sep=1cm, column sep=1cm] {
        ...
        \node[draw, fill=red, circle] (11) at (-1.5, -3) {\textcolor{white}{11}};
        \node[draw, fill=red, circle] (13) at (-0.5, -3) {\textcolor{white}{13}};
        \node[draw, fill=red, circle] (16) at (0.5, -3) {\textcolor{white}{16}};
        \node[draw, fill=red, circle] (19) at (1.5, -3) {\textcolor{white}{19}};
