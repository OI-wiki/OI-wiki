...
\tikzset{
    ...
    trinode/.style={draw, isosceles triangle, isosceles triangle stretches, text=black, font=\bfseries, minimum size=0.4cm, shape border rotate=90, isosceles triangle apex angle=40, line width=0.03cm},
