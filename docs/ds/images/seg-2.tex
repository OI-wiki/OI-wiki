...
\node at (6.95,-3.45) {$7$};
\draw (8,-3) node[small label] {12} rectangle (9.9,-3.9);
\node at (8.95,-3.45) {$[8,9]$};
\draw (10,-3) node[small label] {13} rectangle (11.9,-3.9);
\node at (10.95,-3.45) {$10$};
\draw (12,-3) node[small label] {14} rectangle (13.9,-3.9);
\node at (12.95,-3.45) {$[11,12]$};
\draw (14,-3) node[small label] {15} rectangle (15.9,-3.9);
\node at (14.95,-3.45) {$13$};
% Layer 5.
...
\node at (5.45,-4.45) {$6$};
\draw[dashed] (6,-4) node[small label] {22} rectangle (6.9,-4.9);
\node at (6.45,-4.45) {};
\draw[dashed] (7,-4) node[small label] {23} rectangle (7.9,-4.9);
\node at (7.45,-4.45) {};
\draw (8,-4) node[small label] {24} rectangle (8.9,-4.9);
\node at (8.45,-4.45) {$8$};
\draw (9,-4) node[small label] {25} rectangle (9.9,-4.9);
\node at (9.45,-4.45) {$9$};
\draw[dashed] (10,-4) node[small label] {26} rectangle (10.9,-4.9);
\node at (10.45,-4.45) {};
\draw[dashed] (11,-4) node[small label] {27} rectangle (11.9,-4.9);
\node at (11.45,-4.45) {};
\draw (12,-4) node[small label] {28} rectangle (12.9,-4.9);
\node at (12.45,-4.45) {$11$};
\draw (13,-4) node[small label] {29} rectangle (13.9,-4.9);
\node at (13.45,-4.45) {$12$};
