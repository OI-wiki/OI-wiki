...
\begin{tikzpicture}
    \matrix[row sep=1cm, column sep=1cm] {
        ...
        \node[draw, fill=red, circle] (9) at (-2.5, -3) {\textcolor{white}{9}};
        \node[draw, fill=red, circle] (22) at (2.5, -3) {\textcolor{white}{22}};
        \node[draw, fill=red, circle] (28) at (3.5, -3) {\textcolor{white}{28}};
        \node[draw, fill=red, circle] (40) at (4.5, -3) {\textcolor{white}{40}};
