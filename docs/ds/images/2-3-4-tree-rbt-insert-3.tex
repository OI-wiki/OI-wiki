...
\begin{tikzpicture}
    \matrix[row sep=1cm, column sep=1cm] {
        ...
        \node[draw, fill=red, circle] (1) at (-5.5, -3) {\textcolor{white}{1}};
        \node[draw, fill=red, circle] (3) at (-4.5, -3) {\textcolor{white}{3}};
        \node[draw, fill=red, circle] (5) at (-3.5, -3) {\textcolor{white}{5}};
        \node[draw, fill=red, circle] (7) at (-2.5, -3) {\textcolor{white}{7}};
