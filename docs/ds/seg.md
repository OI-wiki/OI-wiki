author: Marcythm, Ir1d, Ycrpro, Xeonacid, konnyakuxzy, CJSoft, HeRaNO, ethan-enhe, ChungZH, Chrogeek, hsfzLZH1, billchenchina, orzAtalod, luoguojie, Early0v0, wy-luke, 383494
...
-   查理线段树优化：堆式建树中节点 $p$ 的两个儿子分别为 $2p$ 和 $2p+1$，将它们换成 $2mid$ 和 $2mid+1$ 即可将线段树的空间需求降至 $2n$。具体证明见[洛谷上的原帖](https://www.luogu.com/discuss/531072?page=2)。另外，无论线段树维护的是闭区间还是半开半闭区间，查理线段树都能正确维护。
