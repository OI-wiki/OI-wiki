...
$$
\begin{align}
1+w^{'}(x)+w^{'}(fa)+w^{'}(g)−w(x)−w(fa)−w(g) \leq \\
1+w^{'}(fa)+w^{'}(g)−w(x)−w(fa) \leq  \\
1+ w^{'}(x)+w^{'}(g)−2w(x) \leq \\
3(w^{'}(x)−w(x))
\end{align}
$$
...
1+w^{′}(fa)+w^{′}(g)−w(x)−w(fa) \leq \\
1+w^{′}(g)+w^{′}(fa)−2w(x) \leq \\
2 w^{′}(x)−w^{′}(g)−w^{′}(fa) + w^{′}(fa)+w^{′}(g)−w(x)−w(fa) \leq \\
2(w^{′}(x)−w(x))
\end{align}
$$
...
$$
3(w^{'}(x_{1})−w(x_{1})+w^{''}(x_{1})−w^{'}(x_{1})+ \cdots +w(n)−w^{'''}\cdots(x_{1}))+1 = \\
3(w(n)−w(x_{1}))+1 \leq \log n
$$

继而可得：

$$
\varphi (m)−\varphi (m−1)+\varphi (m−1)−\varphi (m−2)...+\varphi (1)−\varphi (0)+\varphi (0) = \\
n \log n+m \log n
$$
