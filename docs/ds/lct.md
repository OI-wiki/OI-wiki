...
2.  **访问虚边**
    ...
    -   **轻虚边**：从节点 $v$ 到其父节点的虚边，其中 $size(v) \leqslant \frac{1}{2} size(parent(v))$。
...
???+ note " 例题 [「国家集训队」Tree II](https://www.luogu.com.cn/problem/P1501)"
    ...
    4.  `/ u v`：输出树上 $u,v$ 两点之间的路径上的点权之和对 $51061$ 取模后的值。
        ...
        $1\leqslant n,q\leqslant 10^5,0\leqslant c\leqslant 10^4$
...
???+ note " 例题 [「SDOI2008」洞穴勘测](https://www.luogu.com.cn/problem/P2147)"
    ...
    $n\leqslant 10^4, m\leqslant 2\times 10^5$
...
???+ note " 例题 [「AHOI2005」航线规划](https://www.luogu.com.cn/problem/P2542)"
    ...
    $1<n<3\times 10^4,1<m<10^5,0\leqslant q\leqslant 4\times 10^4$
...
???+ note " 例题 [luogu P4234 最小差值生成树](https://www.luogu.com.cn/problem/P4234)"
    ...
    $1\leqslant n\leqslant 5\times 10^4,1\leqslant m\leqslant 2\times 10^5,1\leqslant w_i\leqslant 10^4$
...
???+ note " 例题 [「BJOI2014」大融合](https://loj.ac/problem/2230)"
    ...
    $1\leqslant n,q,x,y\leqslant 10^5$
