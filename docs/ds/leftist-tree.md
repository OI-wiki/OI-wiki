...
由于每递归一层，其中一个堆根节点的 $dist$ 就会减小 $1$，而 “一棵有 $n$ 个节点的二叉树，根的 $dist$ 不超过 $\left\lceil\log (n+1)\right\rceil$”，所以合并两个大小分别为 ​$n$ 和 ​$m$ 的堆复杂度是 ​$\mathcal O(\log n+\log m)$。
...
[「JLOI2015城池攻占」](https://www.luogu.org/problemnew/show/P3261)
