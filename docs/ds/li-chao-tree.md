...
![$k_f > k_g$，$f(mid) > g(mid)$](./images/li-chao-tree-1.svg)

2. 反之，旧线段在左半区间 **一定** 最优，新线段在右半区间 **可能** 最优。

![$k_f > k_g$，$f(mid) < g(mid)$](./images/li-chao-tree-2.svg)

接下来考虑新线段斜率小于原线段的情况，

1. 如果新线段在 $mid$ 处更优，则新线段在左半区间 **一定** 最优，旧线段在右半区间 **可能** 最优；

![$k_f < k_g$，$f(mid) > g(mid)$](./images/li-chao-tree-4.svg)

2. 反之，旧线段在右半区间 **一定** 最优，新线段在左半区间 **可能** 最优。

![$k_f < k_g$，$f(mid) < g(mid)$](./images/li-chao-tree-3.svg)
