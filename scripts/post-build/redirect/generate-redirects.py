...
for cur in f.readlines():
    ...
    with open(html_path, 'w') as html_file:
        ...
        html_file.write(f'<!DOCTYPE html><html><head><link rel="canonical" href="${t}"/><meta name="robots" content="noindex"><meta charset="utf-8" /><meta http-equiv="refresh" content="0; url=${t}" /></head></html>')
        # print(html_path)
