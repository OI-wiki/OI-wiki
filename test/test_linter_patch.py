...
class TestApplyPostprocess(unittest.TestCase):
    """Test cases for apply_postprocess function."""

    def test_basic_postprocessing(self):
        """Test basic postprocessing functionality."""
        test_file = os.path.join(tempfile.mkdtemp(), "post_test.md")
    ...
    def test_empty_content_postprocessing(self):
        """Test postprocessing with empty content."""
        test_file = os.path.join(tempfile.mkdtemp(), "empty_post_test.md")
