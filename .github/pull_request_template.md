...
- 请在 PR 之前检查一下您的 PR 是否存在以下常见问题：
   ...
   * [ ] 行间公式前后各要有一行空行。
   * [ ] 对于目录中存在公式的情况，请使用 HTML 代码而非直接插入公式以避免双倍公式的问题，请参考[避免 ToC 中双倍公式的写法](https://github.com/24OI/OI-wiki/blame/master/docs/string/sam.md#L82)。
